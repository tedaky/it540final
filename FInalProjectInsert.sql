...
GO
EXEC [sp_CreateOrder] @CustomerID = 1, @OrderDate = '2015-09-25', @No_of_Tickets = 1, @ShowingID = 6, @CategoryID = 1;
GO
...
GO
EXEC [sp_CreateOrder] @CustomerID = 4, @OrderDate = '2010-09-25', @No_of_Tickets = 1, @ShowingID = 1, @CategoryID = 6;
GO
